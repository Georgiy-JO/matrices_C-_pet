...
| ✔     | Make it as a static library (with matrix_cpp.h header file);                                                                                                                                        |
...
| ✔     | Provide a Makefile for building the library and tests (with targets all, clean, test, matrix_cpp.a).                                                                                                |
